        ...
        <div className="flex-grow mt-4 bg-[#f3ba2f] rounded-t-[48px] relative top-glow z-0">
          <div className="mt-[2px] bg-[#1d2025] rounded-t-[46px] h-full overflow-y-auto no-scrollbar">
            <div className="px-4 pt-1 pb-24">
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div className="flex flex-col ml-2">
                      ...
                      <span className="font-normal text-gray-500">{energyRefillsLeft}/1 available</span>
                    </div>
                  </div>
                  {isLoadingRefill ? (
                    ...
                    <span className="text-[#44b75e]">Refill</span>
                  )}
                </button>
              </div>
              ...
              <div className="mt-4">
                <button className="w-full flex justify-between items-center bg-[#272a2f] rounded-lg p-4"
                  ...
                  {isLoadingMultitap ? (
                    ...
                    <span className="text-[#44b75e]">Coming Soon</span>
                  )}
                </button>
                <button className="w-full flex justify-between items-center bg-[#272a2f] rounded-lg p-4 mt-2" disabled={isLoadingEnergyLimit || !isEnergyLimitAffordable}>
                  <div className="flex items-center">
              ...
              <button onClick={() => handleViewChange("game")} className="mx-auto block mt-4 text-center text-[#44b75e]">
                Back to Game
              </button>
            </div>
          </div>
